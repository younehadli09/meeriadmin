...
export default function Nav() {
    ...
    const activeLink = inactiveLink + ' bg-custom-white text-custom-brown rounded-l-lg';
    const pathname = usePathname(); // Use usePathname to get the current path

    return (
        <aside className="text-white p-4 pr-0">
            <Link className='flex gap-1 mb-4 mr-4 text-custom-brown' href="/">
                <svg
